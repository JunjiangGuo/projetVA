...
public class LoginController {
    ...
    public String loginUser(String username, String password, String type, String code, HttpSession httpSession, Model model) throws UnsupportedEncodingException {
        Object seesionCode = httpSession.getAttribute("code");
        if (code == null || code.equals("")) {
            model.addAttribute("status", "The verification code cannot be empty！");
            return "login";
        }
        if (code != null && !code.equalsIgnoreCase(seesionCode.toString())) {
            model.addAttribute("status", "Verification code error！");
            return "login";
        }
        //if (type != null && type.equals("0")) {
            ...
            if (admin != null) {
                ...
                model.addAttribute("status", "Account or password input error！");
                return "login";
            }
//        }else {
...
//        }
    ...
    @RequestMapping(value = "/toUpdateAdminPss")
    ...
    //修改管理员
    @RequestMapping("/updateAdminPss")
    @ResponseBody
    public String updateAdminPss(String newPass, String password, Model model, HttpSession httpSession) {
